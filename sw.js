...
const CACHE_NAME = "nourish-shell-v1.3.0";
...
const APP_SHELL = [
  ...
  "./assets/js/data.js?v=1.3.0",
  "./assets/js/foods-expanded.js?v=1.3.0",
  "./assets/js/storage.js?v=1.3.0",
  "./assets/js/nutrition.js?v=1.3.0",
  "./assets/js/coach.js?v=1.3.0",
  "./assets/js/camera.js?v=1.3.0",
  "./assets/js/reminders.js?v=1.3.0",
